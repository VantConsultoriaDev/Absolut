  ...
  switch (tableName) {
    ...
    case 'parceiros':
      return {
        ...
        endereco: cleanedItem.endereco, cidade: cleanedItem.cidade, estado: cleanedItem.estado, cep: cleanedItem.cep, observacoes: cleanedItem.observacoes, is_motorista: cleanedItem.isMotorista, is_active: cleanedItem.isActive,
      };
    case 'motoristas':
      return {
        ...base,
...
export const mapFromSupabase = (tableName: string, item: any) => {
  ...
  switch (tableName) {
    case 'clientes':
      return {
        ...base,
        tipo: item.tipo, nome: item.nome, nomeFantasia: item.nome_fantasia, documento: item.documento, email: item.email, telefone: item.telefone, endereco: item.endereco, cidade: item.cidade, estado: item.estado, cep: item.cep, observacoes: item.observacoes, isActive: item.is_active, avatarUrl: item.avatar_url,
      } as Cliente;
    case 'parceiros':
      return {
        ...base,
        tipo: item.tipo, nome: item.nome, nomeFantasia: item.nome_fantasia, documento: item.documento, cnh: item.cnh, email: item.email, telefone: item.telefone, 
        pixKeyType: item.pix_key_type, // NOVO
        pixKey: item.pix_key, // NOVO
        pixTitular: item.pix_titular, // NOVO
        endereco: item.endereco, cidade: item.cidade, estado: item.estado, cep: item.cep, observacoes: item.observacoes, isMotorista: item.is_motorista, isActive: item.is_active,
      } as Parceiro;
    case 'motoristas':
      return {
        ...base,
